...
const allProjects = [
  ...
  { id: 26, title: 'WC-renovatie', category: 'WC', location: 'Amsterdam', image: sitePhotos[25], desc: 'Tijdloos sanitair met een verfijnde, moderne uitstraling' },
  { id: 29, title: 'WC-renovatie', category: 'WC', location: 'Haarlem', image: sitePhotos[28], desc: 'Een elegante WC met sterke lijnen en warme details' },
  { id: 39, title: 'WC-renovatie', category: 'WC', location: 'Almere', image: sitePhotos[2], desc: 'Een luxe WC met marmerlook en verfijnde details' },
  { id: 40, title: 'WC-renovatie', category: 'WC', location: 'Amsterdam', image: sitePhotos[38], desc: 'Warme tegels, zwart sanitair en een moderne afwerking' },
  { id: 41, title: 'WC-renovatie', category: 'WC', location: 'Lelystad', image: sitePhotos[39], desc: 'Een stijlvolle WC met douche en rustige materialen' },
  { id: 42, title: 'WC-renovatie', category: 'WC', location: 'Haarlem', image: sitePhotos[40], desc: 'Marmerlook, natuurlijke tinten en een tijdloze uitstraling' },

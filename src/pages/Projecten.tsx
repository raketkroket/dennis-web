...
const allProjects = [
  ...
  { id: 6, title: 'Badkamerproject Denra 01', category: 'Badkamer', location: 'Almere', image: sitePhotos[12], desc: 'Premium badkamer met een rustige, luxe materialenmix' },
  { id: 7, title: 'Badkamerproject Denra 02', category: 'Badkamer', location: 'Amsterdam', image: sitePhotos[13], desc: 'Houten accenten en een tijdloze, warme uitstraling' },
  { id: 8, title: 'Badkamerproject Denra 04', category: 'Badkamer', location: 'Almere', image: sitePhotos[14], desc: 'Natuurlijke afwerkingen en een moderne ruimtelijke indeling' },
  { id: 9, title: 'Badkamerproject Denra 05', category: 'Badkamer', location: 'Lelystad', image: sitePhotos[15], desc: 'Licht, elegant en functioneel in een moderne badkamer' },
  { id: 10, title: 'Badkamerproject Denra 06', category: 'Badkamer', location: 'Almere', image: sitePhotos[16], desc: 'Premium materiaalgebruik en zachte neutraliteit' },
  { id: 11, title: 'Badkamerproject Denra 03', category: 'Badkamer', location: 'Amsterdam', image: sitePhotos[17], desc: 'Minimalistisch en strak met warme materialen' },
  { id: 12, title: 'Badkamerproject Denra 07', category: 'Badkamer', location: 'Almere', image: sitePhotos[18], desc: 'Luxe badkamer met subtiele natuurlijke details' },
  { id: 13, title: 'Badkamerproject Denra 09', category: 'Badkamer', location: 'Lelystad', image: sitePhotos[19], desc: 'Zachte texturen en verfijnde, functionele badkamerarchitectuur' },
  { id: 14, title: 'Badkamerproject Denra 10', category: 'Badkamer', location: 'Amsterdam', image: sitePhotos[20], desc: 'Warmte, rust en hoogwaardige afwerking in een compacte ruimte' },
  { id: 15, title: 'Badkamerproject Denra 11', category: 'Badkamer', location: 'Haarlem', image: sitePhotos[21], desc: 'Luxe badkamer met duidelijke verticale lijnen en rust' },
  { id: 16, title: 'Badkamerproject Denra 12', category: 'Badkamer', location: 'Utrecht', image: sitePhotos[22], desc: 'Premium badkamer met een warme natuurlijke sfeer' },
  { id: 17, title: 'Badkamerproject Denra 13', category: 'Badkamer', location: 'Almere', image: sitePhotos[23], desc: 'Een duurzamer, stijlvol en functioneel badkamerconcept' },
